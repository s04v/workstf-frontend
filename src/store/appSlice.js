...
export const { updateActiveApp, updateObjectList, updateObject, updateRecords, updateRecordToEdit, updateSelectedRecord, updateRecordSkip, updateRecordTake, updateRecordTotal, resetRecords } = appSlice.actions;
